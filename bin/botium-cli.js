...
yargsCmd.usage('Botium CLI\n\nUsage: $0 [options]') // eslint-disable-line
  ...
  .command(wrapHandler(require('../src/import')('botium-connector-alexa-smapi', 'alexa-smapi-import', 'Import convos and utterances from Alexa SMAPI')))
  .command(wrapHandler(require('../src/import')('botium-connector-dialogflow', 'dialogflow-import', 'Import convos and utterances from Google Dialogflow')))
  .command(wrapHandler(require('../src/import')('botium-connector-watson', 'watson-import', 'Import convos and utterances from IBM Watson Assistant')))
  .command(wrapHandler(require('../src/import')('botium-connector-lex', 'lex-import', 'Import convos and utterances from Amazon Lex')))
